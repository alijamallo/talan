export default {
    ...
    landing: {
        mobile: require("./landing/mobile.svg"),
        googlePlay: require("./landing/google-play.svg"),
        iosStore: require("./landing/ios-store.svg"),
        androidStore: require("./landing/android-store.svg"),
        api: require("./landing/api.svg"),
        security: require("./landing/security.svg"),
        ledger: require("./landing/ledger.svg"),
